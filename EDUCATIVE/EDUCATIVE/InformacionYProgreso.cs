...
namespace informacionProgreso
{
    public partial class InformacionYProgreso : Form
    {
        public InformacionYProgreso()
        {
            InitializeComponent();
        }
        ...
        private void imgSlide_ClientSizeChanged(object sender, EventArgs e)
        {
